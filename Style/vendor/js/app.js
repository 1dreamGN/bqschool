...
(function(window, document, $, undefined) {
    ...
    $(function() {
        ...
        var pieOptions = {
            ...
            // Setting this to zero convert a doughnut into a Pie
            animationSteps: 100,
            animationEasing: 'easeOutBounce',
            animateRotate: true,
            animateScale: false,
...
(function(window, document, $, undefined) {
    ...
    $(function() {
        ...
        function toggleFSIcon($element) {
            if (screenfull.isFullscreen) $element.children('em').removeClass('fa-expand').addClass('fa-compress');
            else $element.children('em').removeClass('fa-compress').addClass('fa-expand');
        }
...
(function($, window, document) {
    ...
    var Message = function(options) {
            ...
            '<div class="uk-notify-message alert-dismissable">', '<a class="close">&times;</a>', '<div>' + this.options.message + '</div>', '</div>'
    ...
    $(document).on('click', panelSelector, function() {
        ...
        function destroyPanel() {
            ...
            $.when(parent.trigger(removedEvent, [parent])).done(function() {
                ...
                col.trigger(removedEvent) // An event to catch when the panel has been removed from DOM
                .filter(function() {
                    var el = $(this);
...
(function($, window, document) {
    ...
    $(panelSelector).each(function() {
        ...
        if (!wrapper.length) {
            wrapper = parent.children('.panel-heading').nextAll() //find('.panel-body, .panel-footer')
            .wrapAll('<div/>').parent().addClass('panel-wrapper');
            collapseOpts = {};
        }
...
(function($, window, doc) {
    ...
    $.support.requestAnimationFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame ||
    function(callback) {
